    ...
    <div className="ExamDetailForm row mx-0 mb-3">
      ...
      <div className="col-md-6 ssc-o-level shadow p-3 mb-5 bg-body">
        ...
        <div className="row mb-3 mx-0">
          <div className="col-sm-12 col-md-6">
            ...
            <select name="group" id="group" className="form-control" defaultValue={sscOLevel?.group} onChange={sscInputChangeHandler}>
              {groupList.map((tpm, i) => (
          ...
          <div className="col-sm-12 col-md-6">
            ...
            <input type="number" className="form-control" name="cgpa" id="cgpa" defaultValue={sscOLevel?.cgpa} onChange={sscInputChangeHandler} placeholder="E.G. 3.80" />
          </div>
        </div>
        <div className="row mb-3 mx-0">
          <div className="col-sm-12 col-md-6">
            <label htmlFor="grade">Grade</label>
            <input type="text" className="form-control" name="grade" id="grade" defaultValue={sscOLevel?.grade} onChange={sscInputChangeHandler} placeholder="E.G. A" />
          </div>
          <div className="col-sm-12 col-md-6">
      ...
      <div className="col-md-6 hsc-a-level shadow p-3 mb-5 bg-body">
        ...
        <div className="row mb-3 mx-0">
          <div className="col-sm-12 col-md-6">
            <label htmlFor="group">Group</label>
            <select name="group" id="group" className="form-control" defaultValue={hscALevel?.group} onChange={hscInputChangeHandler}>
              {groupList.map((tpm, i) => (
                <option value={tpm} key={i}>
                  {tpm}
                </option>
          ...
          <div className="col-sm-12 col-md-6">
            <label htmlFor="cgpa">Result</label>
            <input type="number" className="form-control" name="cgpa" id="cgpa" defaultValue={hscALevel?.cgpa} onChange={hscInputChangeHandler} placeholder="E.G. 3.80" />
          </div>
        </div>
        <div className="row mb-3 mx-0">
          <div className="col-sm-12 col-md-6">
            <label htmlFor="grade">Grade</label>
            <input type="text" className="form-control" name="grade" id="grade" defaultValue={hscALevel?.grade} onChange={hscInputChangeHandler} placeholder="E.G. A" />
          </div>
          <div className="col-sm-12 col-md-6">
            <label htmlFor="passing_year">Passing Year</label>
            <input
      ...
      <div className="col-md-6 deploma-level shadow p-3 mb-5 bg-body">
        ...
        <div className="row mb-3 mx-0">
          <div className="col-sm-12 col-md-6">
            <label htmlFor="group">Group</label>
            <select name="group" id="group" className="form-control" defaultValue={deplomaLevel?.group} onChange={deplomaInputChangeHandler}>
              {groupList.map((tpm, i) => (
                <option value={tpm} key={i}>
                  {tpm}
                </option>
      ...
      <div className="col-md-6 degree-level shadow p-3 mb-5 bg-body">
        ...
        <div className="row mb-3 mx-0">
          <div className="col-sm-12 col-md-6">
            <label htmlFor="group">Group</label>
            <select name="group" id="group" className="form-control" defaultValue={degreeLevel?.group} onChange={degreeInputChangeHandler}>
              {groupList.map((tpm, i) => (
                <option value={tpm} key={i}>
                  {tpm}
                </option>
      ...
      <div className="col-md-6 honours-level shadow p-3 mb-5 bg-body">
        ...
        <div className="row mb-3 mx-0">
          <div className="col-sm-12 col-md-6">
            <label htmlFor="group">Group</label>
            <select name="group" id="group" className="form-control" defaultValue={honoursLevel?.group} onChange={honoursInputChangeHandler}>
              {groupList.map((tpm, i) => (
                <option value={tpm} key={i}>
                  {tpm}
                </option>
      ...
      <div className="col-md-6 masters-level shadow p-3 mb-5 bg-body">
        ...
        <div className="row mb-3 mx-0">
          <div className="col-sm-12 col-md-6">
            <label htmlFor="group">Group</label>
            <select name="group" id="group" className="form-control" defaultValue={mastersLevel?.group} onChange={mastersInputChangeHandler}>
              {groupList.map((tpm, i) => (
                <option value={tpm} key={i}>
                  {tpm}
                </option>
