...
function UserContent() {
  ...
  const allPendingUserList = useSelector((state) => state.user.allPendingUserList);
  const allRejectedUserList = useSelector((state) => state.user.allRejectedUserList);
  const allApprovedUserList = useSelector((state) => state.user.allApprovedUserList);
  const selectedTabElement = useSelector((state) => state.admin.selectedTabElement);
